...
export default function AssistantElderFemaleLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/assistant_elder_female', label: 'Dashboard', icon: Home },
    ...
    { href: '/users/assistant_elder_female/committee', label: 'Committee', icon: FileText },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/assistant_elder_female/profile"
