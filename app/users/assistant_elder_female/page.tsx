...
export default function AssistantElderFemalePortalPage() {
  const assistantElder = {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-yellow-200 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <CardContent>
              <p className="text-4xl font-black">{stats.rolesAssigned}</p>
        ...
        <Card className="mb-8 bg-orange-200 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/users/assistant_elder_female/add-member">
              ...
              <Link href="/users/assistant_elder_female/add-gallery">
                <Button 
              ...
              <Link href="/users/assistant_elder_female/assign-roles">
                <Button 
