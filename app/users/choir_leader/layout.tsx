...
export default function ChoirLeaderLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/choir_leader', label: 'Dashboard', icon: Home },
    { href: '/users/choir_leader/add-member', label: 'Add Member', icon: UserPlus },
    { href: '/users/choir_leader/members', label: 'Choir Members', icon: Users },
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-bold text-gray-600 mt-1">
                Manage choir members and activities
              </p>
            </div>
            
            <div className="flex items-center gap-4">
              <Link 
                href="/users/choir_leader/profile"
