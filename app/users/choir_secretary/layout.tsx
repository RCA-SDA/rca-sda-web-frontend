...
export default function ChoirSecretaryLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/choir_secretary', label: 'Dashboard', icon: Home },
    { href: '/users/choir_secretary/add-songs', label: 'Add Songs', icon: Music },
    { href: '/users/choir_secretary/songs', label: 'All Songs', icon: FolderOpen },
  ];
