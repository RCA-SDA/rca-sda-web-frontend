...
import { Music, FileText, Loader2 } from 'lucide-react';
...
export default function ChoirSecretaryProfilePage() {
  ...
  return (
    <>
      ...
      {/* Choir Secretary Responsibilities Card */}
        ...
        <Card className="bg-purple-100 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <CardHeader className="bg-purple-400 border-b-4 border-black">
            <CardTitle className="uppercase flex items-center gap-2">
              ...
              Choir Secretary Responsibilities
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                ...
                <span className="font-bold">Maintain choir attendance records</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Manage choir communications</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Organize choir schedules and events</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Assist with music documentation</span>
              </li>
            </ul>
          </CardContent>
        </Card>
