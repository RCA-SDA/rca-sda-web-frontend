...
export default function EvangelismLeaderFemaleLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/evangelism_leader_female', label: 'Dashboard', icon: Home },
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/evangelism_leader_female/profile"
