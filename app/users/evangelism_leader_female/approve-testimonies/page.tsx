  ...
  return (
    <div className="min-h-screen bg-[#fafafa] py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Stats */}
        <Card className="mb-8 bg-rose-200 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <Card key={testimony.id} className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <CardHeader className="bg-pink-100 border-b-4 border-black">
                  <CardTitle className="uppercase flex items-center justify-between">
                    ...
                    <span className="text-sm font-black uppercase bg-rose-400 px-3 py-1 border-2 border-black">
                      Pending
                    </span>
                  </CardTitle>
                </CardHeader>
      ...
      <DialogContent className="max-w-[calc(100%-2rem)] sm:max-w-6xl w-full max-h-[90vh] overflow-y-auto border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <DialogHeader>
          <div className="flex items-start gap-4 mb-4">
            <div className="w-16 h-16 bg-rose-400 border-4 border-black flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-gradient-to-br from-pink-50 to-rose-50 border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
