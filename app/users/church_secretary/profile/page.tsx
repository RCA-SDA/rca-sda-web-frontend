...
export default function SecretaryProfilePage() {
  ...
  const userData: UserProfileData = {
    ...
    family: currentUser.familly || 'Church Administration',
  ...
  return (
    <>
      ...
      {/* Church Secretary Responsibilities Card */}
          ...
          <CardContent className="pt-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                ...
                <span className="font-bold">Maintain church records and documentation</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Manage church correspondence</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Organize church meetings and schedules</span>
              </li>
              <li className="flex items-start gap-3 p-3 bg-white border-2 border-black">
                <span className="text-purple-600 font-black">✓</span>
                <span className="font-bold">Handle membership administration</span>
              </li>
            </ul>
          </CardContent>
        </Card>
