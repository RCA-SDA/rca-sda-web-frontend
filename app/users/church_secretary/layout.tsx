...
export default function SecretaryLayout({
  ...
  const navLinks = [
    { href: '/users/church_secretary', label: 'Dashboard', icon: Home },
    { href: '/users/church_secretary/new-note', label: 'New Meeting Note', icon: FileText },
    { href: '/users/church_secretary/notes', label: 'All Notes', icon: FolderOpen },
    { href: '/users/church_secretary/calendar', label: 'Meeting Calendar', icon: Calendar },
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-bold text-gray-600 mt-1">
                Manage church meeting notes and records
              </p>
            </div>
            
            <div className="flex items-center gap-4">
              <Link 
                href="/users/church_secretary/profile"
