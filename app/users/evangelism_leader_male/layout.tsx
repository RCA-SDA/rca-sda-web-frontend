...
export default function EvangelismLeaderMaleLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/evangelism_leader_male', label: 'Dashboard', icon: Home },
    ...
    { href: '/users/evangelism_leader_male/committe-meeting', label: 'Committee Meeting', icon: ClipboardList },
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-bold text-gray-600 mt-1">
                Manage blogs, testimonies, and resources
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/evangelism_leader_male/profile"
