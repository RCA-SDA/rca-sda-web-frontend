...
export default function AssistantElderMaleLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/assistant_elder_male', label: 'Dashboard', icon: Home },
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-black uppercase transform -rotate-1">
                Assistant Elder Portal
              </h1>
              <p className="text-sm font-bold text-gray-600 mt-1">
                Manage members, gallery, and roles
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/assistant_elder_male/profile"
