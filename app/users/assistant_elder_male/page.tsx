...
export default function AssistantElderMalePortalPage() {
        ...
        <Card className="mb-8 bg-orange-200 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/users/assistant_elder_male/add-member">
              ...
              <Link href="/users/assistant_elder_male/add-gallery">
                <Button 
              ...
              <Link href="/users/assistant_elder_male/assign-roles">
                <Button 
