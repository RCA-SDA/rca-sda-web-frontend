...
export default function ElderMaleLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/elder_male', label: 'Dashboard', icon: Home },
    { href: '/users/elder_male/add-member', label: 'Add Member', icon: UserPlus },
    { href: '/users/elder_male/add-gallery', label: 'Add Gallery', icon: Image },
    { href: '/users/elder_male/add-choirs', label: 'Add Choirs', icon: Music },
    { href: '/users/elder_male/assign-roles', label: 'Assign Roles', icon: Shield },
    { href: '/users/elder_male/committee-meeting', label: 'Committee Meeting', icon: FileText },
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm font-bold text-gray-600 mt-1">
                Manage members, gallery, choirs, and roles
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/elder_male/profile"
                className="flex items-center gap-2 px-4 py-2 bg-blue-400 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all"
              >
