...
export default function ElderFemalePortalPage() {
  const elder = {
        ...
        <Card className="mb-8 bg-orange-200 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/users/elder_female/add-member">
              ...
              <Link href="/users/elder_female/add-gallery">
                <Button 
              ...
              <Link href="/users/elder_female/add-choirs">
                <Button 
              ...
              <Link href="/users/elder_female/assign-roles">
                <Button 
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-white border-2 border-black">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-600">Jane Doe joined Ebenezer</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-white border-2 border-black">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-600">3 new photos from prayer meeting</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-white border-2 border-black">
                ...
                <div>
                  <p className="font-black">New choir created</p>
                  <p className="text-sm font-bold text-gray-600">Women's Praise Choir established</p>
                </div>
              </div>
            </div>
          </CardContent>
