...
export default function GrandFatherLayout({
  children,
}: {
  ...
  const navLinks = [
    { href: '/users/grand_father', label: 'Dashboard', icon: Home },
    { href: '/users/grand_father/create-family', label: 'Create Family', icon: FolderPlus },
    { href: '/users/grand_father/add-member', label: 'Add Member', icon: UserPlus },
    { href: '/users/grand_father/family', label: 'All Families', icon: Users },
    { href: '/users/grand_father/committee-meeting', label: 'Committee Meeting', icon: FileText },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Profile */}
              <Link 
                href="/users/grand_father/profile"
      ...
      <div className="flex">
        ...
        >
          ...
          <button
            ...
            className="absolute -right-4 top-4 w-8 h-8 bg-purple-400 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all flex items-center justify-center z-50"
          >
            {isCollapsed ? (
              ...
              {navLinks.map(({ href, label, icon: Icon }) => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-3 font-black uppercase text-sm transition-all ${
                    isActive(href)
                      ? 'bg-purple-400 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transform -rotate-1'
